...
c = C('yard_toolcrib', 0, 1, 33)
c.climb(width=12, step=9, direction=1, start=12)
c.put(2, 19, '!')
c.spurs([2, 7], side=-1, length=4, gap=3)
c.deco(9, 30, 'xxx')
c.wall_spikes(11, -1, 2)
c.hazard(2, '^', side=-1, length=3)
c.underhang(9, length=3)
c.hold(2)
c.gate(5)
chunks.append(c.check())
...
c = C('foundry_bulkhead', 1, 2, 33)
c.climb(width=10, step=7, direction=1, start=6)
c.put(2, 19, '!')
c.ledge(29, 33, 5, '#', '~').ledge(11, 2, 4, '#', '~')
c.wall_spikes(20, 1, 2)
...
c = C('freeze_airlock', 2, 2, 33)
c.climb(width=10, step=6, direction=-1, start=10)
c.put(2, 19, '!')
c.col(3, 6, 18, 'W')
c.restyle([2, 8], 'i')
c.hazard(9, '^', side=1, length=2)
c.underhang(1, length=3)
c.gate(1)
c.hold(6)
chunks.append(c.check())
...
c = C('spire_hatch', 3, 3, 33)
c.climb(width=10, step=7, direction=1, start=10)
c.put(2, 19, '!')
c.col(37, 6, 27, '*')
c.deco(21, 4, 'xxx')
c.saw(x=8, y=24, r=1, ax=0, ay=6, period=150)
c.hazard(5, '^', side=1, length=3)
c.underhang(9, length=3)
c.sweep(2, period=185)
c.hold(3)
c.gate(6)
chunks.append(c.check())

# ============================================ GAUNTLET-ONLY — THE BACK LOT ====
# Twenty-four rooms the campaign never opens.
#
...
c = C('yard_sidegate', 0, 1, 30, tags=['spare'])
c.climb(width=10, step=6, direction=-1, start=8)
c.put(2, 19, '!')
c.col(2, 6, 22, '*')
c.deco(9, 30, 'xxxx')
c.hazard(5, '^', side=1, length=2)
c.underhang(2, length=3)
c.hold(3)
c.gate(7)
chunks.append(c.check())
...
c = C('foundry_damper', 1, 2, 36, tags=['spare'])
c.climb(width=11, step=(8, 5), direction=-1, start=5)
c.put(2, 19, '!')
c.ledge(20, 2, 5, '#', '~')
c.restyle([9], 'c')
c.hazard(5, '^', side=-1, length=3)
c.underhang(10, length=3)
c.crusher(2, period=180)
c.hold(2)
c.gate(5)
c.gate(7)
chunks.append(c.check())
...
c = C('freeze_coldstore', 2, 3, 27, tags=['spare'])
c.climb(width=12, step=9, direction=-1, start=12)
c.put(2, 19, '!')
c.restyle([1, 6], 'i')
c.wall_spikes(9, 1, 2)
...
c = C('spire_windlass', 3, 3, 39, tags=['spare'])
c.climb(width=10, step=7, direction=1, start=8)
c.put(2, 19, '!')
c.spurs([2, 11], side=-1, length=4, gap=3)
c.wall_spikes(34, 1, 2)
c.restyle([10], 'i')
c.hazard(6, '^', side=-1, length=3)
c.underhang(10, length=3)
c.hold(3)
c.gate(6)
c.gate(9)
